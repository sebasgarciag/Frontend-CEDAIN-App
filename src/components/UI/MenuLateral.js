...
import ListadoProductosS from '../../../app/listadoProductos';
...
function Menulateral() {
  return (
    ...
    drawerContent = { (props) => <MenuItems {...props} /> } >
      ...
      <Drawer.Screen name="listadoProductos" component={ListadoProductosS} options={{ headerTransparent: true, headerShown: false }} />
